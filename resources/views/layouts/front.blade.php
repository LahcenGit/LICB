                ...
                <div class="row">
                    ...
                    <div class="footer-link-widget widget-install-app col wow animate__animated animate__fadeInUp" data-wow-delay=".5s">
                        ...
                        <div class="download-app">
                            ...
                            <a href="#" class="hover-up mb-sm-2"><img src="{{asset('front/assets/imgs/theme/google-play.jpg')}}" alt="" /></a>
                        </div>
                        <p class="mb-20">Secured Payment Gateways</p>
                        <img class="" src="{{asset('front/assets/imgs/theme/payment-method.png')}}" alt="" />
                    </div>
                </div>
        </section>
