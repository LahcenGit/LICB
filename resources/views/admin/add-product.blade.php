                                    ...
                                    <div class="basic-form" >
                                        <div id="dynamicAddRemove">
                                          <div  class="row">
                                                ...
                                                <select  class="form-control" id="select-content"  class="selectpicker" data-live-search="true" name="attributes[0]"  required>
                                                ...
                                                <select  class="form-control" id="select-choix"  class="selectpicker" data-live-search="true" name="choix[0]"  required>
