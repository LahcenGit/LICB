                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="{{url('dashboard-admin/attributes/'.$attribute->id)}}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <select class="form-control " id="sel1"  class="selectpicker" data-live-search="true" name="type">
                                                    ...
                                                    <option value="{{$attr->id}}" @if( $attr->id == $attribute->attribute_id ) selected @endif >{{$attr->value}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
